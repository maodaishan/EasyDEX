...
(0, ava_1.default)('make namespaced input - custom layout', async (t) => {
    const origBuildInfo = await hardhat_1.artifacts.getBuildInfo('contracts/test/NamespacedToModifyCustomLayout.sol:ExampleCustomLayout');
