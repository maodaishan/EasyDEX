...
function loadBaseSlot(contractDef, decodeSrc, layout) {
    if (contractDef.storageLayout !== undefined) {
        if (contractDef.storageLayout.baseSlotExpression.nodeType !== 'Literal') {
            ...
            throw new error_1.UpgradesError(`${src}: Custom storage layout expression with node type ${contractDef.storageLayout.baseSlotExpression.nodeType} is not currently supported`, () => 'Please report this at https://zpl.in/upgrades/report and include the `layout at` expression from your contract.');
        }
