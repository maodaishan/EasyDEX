...
function makeDeployBeaconProxy(hre, defenderModule) {
    return async function deployBeaconProxy(beacon, attachTo, args = [], opts = {}) {
        ...
        const BeaconProxyFactory = opts.proxyFactory || (await (0, utils_1.getBeaconProxyFactory)(hre, (0, utils_1.getSigner)(attachTo.runner)));
        const proxyDeployment = Object.assign({ kind: opts.kind }, await (opts.deployFunction || utils_1.deploy)(hre, opts, BeaconProxyFactory, beaconAddress, data));
